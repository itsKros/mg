...
--
-- Host: 10.10.11.23
-- Generation Time: Apr 25, 2019 at 11:57 AM
...
(1, 'Welcome To Montreal Gentleman', '<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis repudiandae ipsam, vitae obcaecati alias fugiat similique ut magni in qui ratione, cupiditate impedit, inventore repellat iure earum optio? Obcaecati hic dolor iste molestias, recusandae non dolorum in voluptatem eveniet aliquid vero beatae vel officiis ducimus cumque doloribus voluptatibus corporis aliquam natus consequatur modi! Aperiam voluptatibus fuga hic error quaerat quisquam.</p>', 'How Our Encounters Work', '<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis repudiandae ipsam, vitae obcaecati alias fugiat similique ut magni in qui ratione, cupiditate impedit, inventore repellat iure earum optio?</p>\r\n\r\n<p>Eveniet aliquid vero beatae vel officiis ducimus cumque doloribus voluptatibus corporis aliquam natus consequatur modi! Aperiam voluptatibus fuga hic error quaerat quisquam.</p>\r\n\r\n<p>Recusandae non dolorum in voluptatem eveniet aliquid vero beatae vel officiis ducimus cumque doloribus voluptatibus corporis aliquam natus consequatur</p>', 'Services', '<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis repudiandae ipsam, vitae obcaecati alias fugiat similique ut magni in qui ratione, cupiditate impedit, inventore repellat iure earum optio?</p>\r\n\r\n<p>Eveniet aliquid vero beatae vel officiis ducimus cumque doloribus voluptatibus corporis aliquam natus consequatur modi! Aperiam voluptatibus fuga hic error quaerat quisquam.</p>\r\n\r\n<p>Recusandae non dolorum in voluptatem eveniet aliquid vero beatae vel officiis ducimus cumque doloribus voluptatibus corporis aliquam natus consequatur</p>', '2019-04-12 02:30:00', '2019-04-11 22:03:42');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `modeldetail` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Admin', 'ssquaresdev@gmail.com', NULL, '$2y$10$gwNPprACpksyiSnnUYBKleAt.urSvUSY/bAWhtJ8DY.ViBGlBLNIS', 'nvxtFRyxFvFzlQLKtoTslO4gFYbntCTZNhy3v22rKWwEyeMuZWnoJFnASGjs', '2019-04-09 06:20:45', '2019-04-25 10:03:21', '', '', 0.00, 0, '', '', 1, 'Admin_1556134249.png', 'default-featured.jpg', '', ''),
(3, 'Kros', 'roshan@ssquares.co.in', NULL, '$2y$10$KlTcU7Ya3Z3xeL5zjVcQ5.2w/U4DfRyHdLdCpedxQFX5Tp4OQu1kK', 'md1xe8oaM57MDPEvRXwhZgsb7OMbJ3RRbZyD2lUCDeOud7PS7JsotREyC1S6', '2019-04-23 23:38:14', '2019-04-25 00:50:44', '<p>Morbi ornare lectus quis justo gravida semper. Nulla tellus mi, vulputate adipiscing cursus eu, suscipit id nulla. Donec a neque libero. Pellentesque aliquet, sem eget laoreet ultrices, ipsum metus feugiat sem, quis fermentum turpis eros eget velit. Donec ac tempus ate.</p><p>Morbi ornare lectus quis justo gravida semper. Nulla tellus mi, vulputate adipiscing cursus eu, suscipit id nulla. Donec a neque libero. Pellentesque aliquet, sem eget laoreet ultrices, ipsum metus feugiat sem, quis fermentum turpis eros eget velit. Donec ac tempus ante.</p><p>Morbi ornare lectus quis justo gravida semper. Nulla tellus mi, vulputate adipiscing cursus eu, suscipit id nulla. Donec a neque libero. Pellentesque aliquet, sem eget laoreet ultrices, ipsum metus feugiat sem, quis fermentum turpis eros eget velit. Donec ac tempus ante.</p>', '6\'5', 170.00, 32, 'Blonde', 'Hazel', NULL, 'Kros_1556111661.jpg', 'Kros_1556111715_featured.jpg', '', ''),
...
--
-- Indexes for table `homeinfo`
--
ALTER TABLE `homeinfo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `homeinfo`
--
ALTER TABLE `homeinfo`
