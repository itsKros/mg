                            ...
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="onehour">Add Price <small>(in USD)</small></label>
                        ...
                        <div class="col-md-4 package">
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="fourhour">Add Price <small>(in USD)</small></label>
                                        <input type="text" id="fourhour" name="fourhour" value="{{$package->fourhour}}" class="form-control form-control-line">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 package">
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="eighthour">Add Price <small>(in USD)</small></label>
                        ...
                        <div class="col-md-4 package">
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="twentyfourhour">Add Price <small>(in USD)</small></label>
                        ...
                        <div class="col-md-4 package">
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="weekend">Add Price <small>(in USD)</small></label>
                        ...
                        <div class="col-md-4 package">
                            <div class="card card-outline-inverse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="week">Add Price <small>(in USD)</small></label>
