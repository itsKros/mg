                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @if(Auth::user()->avatar)
                                    <img src="/public/uploads/avatars/{{Auth::user()->avatar}}" alt="{{Auth::user()->name}}" class="profile-pic m-r-10" />{{Auth::user()->name}}
                                @else
                                <img src="/public/uploads/avatars/default.png" alt="{{Auth::user()->name}}" class="profile-pic m-r-10" />{{Auth::user()->name}}
                                @endif
                            </a>
                        </li>
                    </ul>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="{{route('admin.home')}}" aria-expanded="false"><i class="fas fa-tachometer-alt"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('homeinfo.edit',['id'=>1])}}" aria-expanded="false"><i class="fas fa-home"></i><span class="hide-menu">Home Info</span></a>
